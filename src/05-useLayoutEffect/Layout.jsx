...
import { CharacterInfo, LoadingCharacter } from "../03-examples";
    ...
    return (
        <>
...

            {
                isLoading
                ? <LoadingCharacter />
                : <CharacterInfo name={data.name} image={data.image} gender={data.gender} status={data.status} episode={data.episode} />
